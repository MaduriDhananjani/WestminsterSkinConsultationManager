...
public class AppointsTableModel extends AbstractTableModel {
    private final String[] columnName = {"Patient Id", "Patient's First Name", "Patient's Last Name", "Date Of Birth"," " , "Mobile Number", "Name of the Doctor", "Specialization", "Reserved date", "Reserved Time Slot", "Fee"};
    private final ArrayList<Patient> patientList;
    private final ArrayList<Consultation> consultationList;

    AppointsTableModel(ArrayList<Patient> listOfPatients, ArrayList<Consultation> consultationList) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        if (columnIndex == 0) {
            ...
            temp = consultationList.get(rowIndex).getDocName();
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        Patient row = ConsultationGUI.patients.get(rowIndex);
        if (0 == columnIndex) {
            ...
            JOptionPane.showMessageDialog(null, "You can't change the values in this field!", "ALERT!", JOptionPane.WARNING_MESSAGE);
